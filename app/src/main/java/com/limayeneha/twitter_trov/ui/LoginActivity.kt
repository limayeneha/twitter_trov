...
class LoginActivity : AppCompatActivity() {
    ...
    private fun showEmailMessage(show: Boolean?) {
        if ((!show!!)!! || TextUtils.isEmpty(binding.etEmail.text)) {
    ...
    private fun showPasswordMessage(show: Boolean?) {
        if ((!show!!)!! || TextUtils.isEmpty(binding.etPassword.text)) {
    ...
    @NonNull
    private fun getViewModel(emailChangeObservable: Observable<CharSequence>, passwordChangeObservable: Observable<CharSequence>): LoginViewModel {
